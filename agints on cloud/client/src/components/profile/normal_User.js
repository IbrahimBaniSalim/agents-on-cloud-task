...
const User = () => {
  ...
  return (
    ...
    <div className="marginTopProfile">
      ...
      <div className="myServiceInUserProfileDev">
                    <div className="nameLabelServiceFavUser1">My Favourite Services</div>
                    <div className="scrollUserProfile1">
                    {state.favorite &&
                      state.favorite.map((elem, i) => (
                        <div key={i} className="gridServiceFavUserProfile">
                          <div>
                            <img src={elem.photo} className="imageServiceFavUser1"/>
                          </div>
                          <div>
                            <div className="textServiceFavUserProfile12">{elem.Service}</div>
                            <Button
                            variant="outline-dark"
                            className="buttonDeleteServiceFavUser1"
                              onClick={() => {
                                const ServiceId = elem.Service_id;
                                ...
                                dispatch(deleteFavorite(ServiceId));
                                setState1(!state);
                              }}
                              >
                              Remove 
